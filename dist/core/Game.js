...
export class Game {
    ...
    populateEnemies() {
        const enemies = this.map.enemySpawns.map((s) => new Enemy(s.x, s.y, { health: s.health, damage: s.damage, kind: s.kind, lootLevel: s.lootLevel }));
    ...
    render(fps) {
        ...
        if (this.menu.open) {
            ...
            r.text("J atk · K cast · Q spell · Z shout · V cycle · L block · F potion · E talk · I menu", r.width / 2, r.height - 14, "#7e879a", "11px monospace", "center");
