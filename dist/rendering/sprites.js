...
function dragonPalette(kind) {
    if (kind === "Alduin")
        return { body: "#2b2533", belly: "#463f54", wing: "#1c1726", horn: "#0c0a12", eye: "#ff3b30", hi: "#5b5168" };
    if (kind === "Sahloknir")
        return { body: "#7d6a3a", belly: "#b79a55", wing: "#5e4f2c", horn: "#352b1c", eye: "#ffd24a", hi: "#c9ad6a" };
...
export function drawDragon(ctx, d, time) {
    ...
    if (!dragonBuf)
        dragonBuf = document.createElement("canvas");
    dragonBuf.width = bcw;
